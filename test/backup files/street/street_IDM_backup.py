#!/usr/bin/env python
"""
Custom street run based on the user-defined route layout.

This version keeps the same procedural map and IDM-driven ego vehicle, and
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(HELP_MESSAGE)
        print("Street IDM custom route loaded.")
