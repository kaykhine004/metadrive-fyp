...
TOTAL_EPISODES        = 10
AUTO_PRESS_F          = True   # press F once after window opens → unlimited FPS
...
OUTPUT_DIR = r"C:\Users\User\Desktop\FYP\metadrive0305\metadrive-main\test\Final analysis\Intersection analysis\expert test result"
...
if __name__ == "__main__":
    ...
    try:
        ...
        # ── Speed up: F = unlimited FPS (MetaDrive) — after window is ready ─
        if AUTO_PRESS_F:
            time.sleep(1.5)
            pyautogui.press("f")
            print("[INFO] Pressed F — simulation running at unlimited FPS.")
        fast_mode = AUTO_PRESS_F
